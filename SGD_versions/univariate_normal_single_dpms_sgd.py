# univariate_normal_single_dpms_sgd.py
...
def main():
    ...
    results_dir = "SGD_results/univariate_normal_single"
    ...
    pdf = sps.norm.pdf(xs, loc=mean, scale=np.sqrt(var))

    plt.figure(figsize=(8, 4))
    plt.plot(xs, pdf, label="True PDF (Normal)", color="blue")
